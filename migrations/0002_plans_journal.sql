-- migrations/0002_plans_journal.sql — plans, plan ops, crash journal, apply log
-- (design.md, Data Model Changes). Access layers land with PR 9 (planner) and
-- PR 11 (executor); the schema ships now so the catalog version is stable.
